# MIRRORED — sibling at services/api/review_types.py; keep in lockstep. See docs/adr/0001-mirror-with-rule-of-three-deferral.md.
...
Persona = Literal["chief", "elder", "guard"]
...
_KEY_TO_PERSONA: dict[str, Persona] = {"tpm": "chief", "code_reviewer": "elder", "guard": "guard"}
