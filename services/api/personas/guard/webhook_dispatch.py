# MIRRORED — sibling at services/webhook/personas/guard/webhook_dispatch.py; keep in lockstep. See docs/adr/0001-mirror-with-rule-of-three-deferral.md.
...
function (this file is mirrored into the api service where the loop
never runs).
"""
